...
<div class="contenedor-principal">
    ...
    <main class="main-tienda">
        ...
        <div class="container-pro">
            ...
            <figure>
                <img class="fotos" src="<?php echo  BASE_URL . $producto['imagen']; ?>" alt="<?php echo BASE_URL . $producto['imagen']; ?>">
            </figure>
            ...
            <div class="parte-inferior">
                ...
                <div class="tallas-precio">
                        ...
                        <div class="botones-card">
                            ...
                            <a href="#!" prod="<?php echo $producto['id']; ?>" class="btn-cora btnAddDeseo"><i class="bi bi-heart-fill"></i></a>
                            <a href="#!"prod="<?php echo $producto['id']; ?>"  class="btn-carrito btnAddcarrito"><i class="bi bi-bag-plus"></i></a>
                            <a  href="<?php  echo BASE_URL . 'principal/detail/' . $producto['id']; ?>" class="btn-vista"><i class="bi bi-eye"></i></a>
