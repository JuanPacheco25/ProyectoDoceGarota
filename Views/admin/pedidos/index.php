        ...
        <div class="container-fluid px-4"><br>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="listaPedidos" role="tabpanel" aria-labelledby="home-tab">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover aling-middle" style="width: 100%;" id="tblPendientes">
                                <thead>
                                    <tr>
                ...
                <div class="tab-pane fade" id="listaProceso" role="tabpanel" aria-labelledby="proceso-tab">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover aling-middle" style="width: 100%;" id="tblProceso">
                                <thead>
                                    <tr>
                                        <th>Id transaccion</th>
                                        <th>Monto</th>
                ...
                <div class="tab-pane fade" id="pedidosFinalizados" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover aling-middle" style="width: 100%;" id="tblFinalizados">
                                    <thead>
                                        <tr>
                                            <th>Id transaccion</th>
                                            <th>Monto</th>
            ...
            </div> <!-- Mueve esta etiqueta de cierre al final del bloque de pestañas -->
